				...
				<div id="left_left">
					...
					<div>
						<p>
		    				...
		    				<!-- <input name="predictButton" type="submit" class="btn btn-xs btn-success" value="预测处方" onclick="javascript: form.action='predictMedicineByInput';" /> --> 
		    				<!-- <input name="predictButton" type="submit" class="btn btn-xs btn-success" value="预测处方" /> -->
		    				<input id="predictButton" name="predictButton" type="submit" value="预测处方">
						</p>
			    		<hr>
			    		<p class="text-danger">
